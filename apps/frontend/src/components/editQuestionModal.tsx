      ...
      <div style={styles.modalOverlay}>
        <div style={styles.modalBox}>
                ...
                onClick={() => {
                  if (editTopicInput) {
                    setEditQuestion({
                      ...editQuestion,
                      topic: [
                        ...(Array.isArray(editQuestion.topic)
                          ? editQuestion.topic
                          : [editQuestion.topic]),
                        editTopicInput,
                      ],
              ...
              >
                ...
                <button
                  onClick={() =>
                    setEditQuestion({
                      ...editQuestion,
                      topic: (Array.isArray(editQuestion.topic)
                        ? editQuestion.topic
                        : [editQuestion.topic]
                      ).filter((_, idx) => idx !== i),
                    })
              ...
              >
                ...
                <button
                  onClick={() =>
                    setEditQuestion({
                      ...editQuestion,
                      constraints: (editQuestion.constraints || []).filter(
                        (_, idx) => idx !== i,
                      ),
                    })
                  }
              ...
              <button
                onClick={() => {
                  if (editHintInput) {
                    setEditQuestion({
                      ...editQuestion,
                      hints: [...(editQuestion.hints || []), editHintInput],
                    });
                    setEditHintInput("");
                  }
                }}
              ...
              >
                ...
                <button
                  onClick={() =>
                    setEditQuestion({
                      ...editQuestion,
                      hints: editQuestion.hints.filter((_, idx) => idx !== i),
                    })
                  }
                  style={{
                    ...styles.promoteButton,
          ...
          <label style={styles.modalLabel}>
                  ...
                  if (editSampleInput && editSampleOutput) {
                    setEditQuestion({
                      ...
                      testCases: {
                        ...
                        sample: [
                          ...(editQuestion.testCases.sample || []),
                          {
                            input: editSampleInput,
                            expectedOutput: editSampleOutput,
                          },
                        ],
                      },
                    });
            ...
            {(editQuestion.testCases.sample || []).map(
              (s: TestCase, i: number) => (
                <div
                  key={i}
                  style={{
                ...
                >
                  <span>
                    Input: {s.input} | Output: {s.expectedOutput}
                  </span>
                  <button
                    onClick={() =>
                      setEditQuestion({
                        ...
                        testCases: {
                          ...editQuestion.testCases,
                          sample: editQuestion.testCases.sample.filter(
                            (_, idx) => idx !== i,
                          ),
                        },
                      })
          ...
          <label style={styles.modalLabel}>
                  ...
                  if (editHiddenInput && editHiddenOutput) {
                    setEditQuestion({
                      ...
                      testCases: {
                        ...editQuestion.testCases,
                        hidden: [
                          ...(editQuestion.testCases.hidden || []),
                          {
                            input: editHiddenInput,
                            expectedOutput: editHiddenOutput,
                          },
                        ],
                      },
                    });
            ...
            {(editQuestion.testCases.hidden || []).map(
              (h: TestCase, i: number) => (
                <div
                  key={i}
                  style={{
                ...
                >
                  <span>
                    Input: {h.input} | Output: {h.expectedOutput}
                  </span>
                  <button
                    onClick={() =>
                      setEditQuestion({
                        ...
                        testCases: {
                          ...editQuestion.testCases,
                          hidden: editQuestion.testCases.hidden.filter(
                            (_, idx) => idx !== i,
                          ),
                        },
                      })
          ...
          <label style={styles.modalLabel}>
            ...
            <input
              ...
              onChange={(e) =>
                setEditQuestion({
                  ...editQuestion,
                  modelAnswerTimeComplexity: e.target.value,
                })
              }
              style={styles.modalInput}
            />
          ...
          <label style={styles.modalLabel}>
            ...
            <textarea
              ...
              onChange={(e) =>
                setEditQuestion({
                  ...editQuestion,
                  modelAnswerExplanation: e.target.value,
                })
              }
              style={{
                ...styles.modalInput,

                ...
                <div style={styles.modalBox}>
                    ...
                    <label style={styles.modalLabel}>
                        ...
                        <input
                            ...
                            onChange={(e) => setNewQuestion({ ...newQuestion, modelAnswerTimeComplexity: e.target.value })}
                            style={styles.modalInput}
                        />
                    </label>
                    ...
                    <label style={styles.modalLabel}>
                        ...
                        <textarea
                            ...
                            onChange={(e) => setNewQuestion({ ...newQuestion, modelAnswerExplanation: e.target.value })}
                            style={{ ...styles.modalInput, height: "100px", resize: "vertical" as const }}
                        />
                    </label>

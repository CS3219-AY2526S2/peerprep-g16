      ...
      <div style={styles.modalOverlay}>
        <div style={styles.modalBox}>
              ...
              <button
                onClick={() => {
                  if (topicInput) {
                    setNewQuestion({
                      ...newQuestion,
                      topic: [...newQuestion.topic, topicInput],
                    });
                    setTopicInput("");
                  }
                }}
              ...
              >
                ...
                <button
                  onClick={() =>
                    setNewQuestion({
                      ...newQuestion,
                      topic: newQuestion.topic.filter((_, idx) => idx !== i),
                    })
                  }
                  style={{
              ...
              >
                ...
                <button
                  onClick={() =>
                    setNewQuestion({
                      ...newQuestion,
                      constraints: newQuestion.constraints.filter(
                        (_, idx) => idx !== i,
                      ),
                    })
                  }
              ...
              <button
                onClick={() => {
                  if (hintInput) {
                    setNewQuestion({
                      ...newQuestion,
                      hints: [...newQuestion.hints, hintInput],
                    });
                    setHintInput("");
                  }
                }}
              ...
              >
                ...
                <button
                  onClick={() =>
                    setNewQuestion({
                      ...newQuestion,
                      hints: newQuestion.hints.filter((_, idx) => idx !== i),
                    })
                  }
                  style={{
                    ...styles.promoteButton,
                ...
                <button
                  onClick={() =>
                    setNewQuestion({
                      ...
                      testCases: {
                        ...newQuestion.testCases,
                        sample: newQuestion.testCases.sample.filter(
                          (_, idx) => idx !== i,
                        ),
                      },
                    })
                  ...
                  if (hiddenInput && hiddenOutput) {
                    setNewQuestion({
                      ...
                      testCases: {
                        ...newQuestion.testCases,
                        hidden: [
                          ...newQuestion.testCases.hidden,
                          { input: hiddenInput, expectedOutput: hiddenOutput },
                        ],
                      },
                    });
                    setHiddenInput("");
                ...
                <button
                  onClick={() =>
                    setNewQuestion({
                      ...
                      testCases: {
                        ...newQuestion.testCases,
                        hidden: newQuestion.testCases.hidden.filter(
                          (_, idx) => idx !== i,
                        ),
                      },
                    })
          ...
          <label style={styles.modalLabel}>
            ...
            <input
              type="text"
              value={newQuestion.modelAnswerTimeComplexity}
              onChange={(e) =>
                setNewQuestion({
                  ...newQuestion,
          ...
          <label style={styles.modalLabel}>
            ...
            <textarea
              value={newQuestion.modelAnswerExplanation}
              onChange={(e) =>
                setNewQuestion({
                  ...newQuestion,

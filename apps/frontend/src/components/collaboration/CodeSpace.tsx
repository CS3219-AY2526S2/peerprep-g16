...
export default function CodeSpace({ isExpanded, onToggle, sessionId, userId, socket }: CodeSpaceProps) {
    ...
    useEffect(() => {
        ...
        // get initial code state on join
        ...
        // listen for other user's code changes
        ...
        // request current code state on mount
            ...
            <div style={{
                ...
                <button
                    ...
                    style={{
                        ...
                        background: isRunning ? "#2a9d8f88" : "#2a9d8f", color: "#fff",
                ...
                <button
                    onClick={onToggle}
                    style={{ background: "none", border: "none", color: "#a9b1d6", cursor: "pointer", fontSize: "16px", padding: "0 4px" }}
                    title="Hide code"
                >
                    ×
                </button>
            ...
            <div style={{
                ...
                {output !== null && (
                    <div style={{
                        ...
                        background: "#161b22", fontFamily: "monospace", fontSize: "12px",
                        color: "#2a9d8f", whiteSpace: "pre-wrap", maxHeight: "120px", overflow: "auto",
                    }}>
                        {output}
                    </div>
                )}
